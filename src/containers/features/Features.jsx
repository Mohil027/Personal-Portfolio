      ...
      <div className="card-container">
        {activeTab === 'section1' && (
          ...
          <div className="card-row">
            ...
            <Card projectName="Dynamic Demographic Insights Platform" imageUrl={img2} description={"Insightful demographics data visualization platform for demographic insights, citizen behaviors, and business analytics."} githubLink="https://github.com/Mohil027/Dynamic-Demographic-Insight-Platform" />
          ...
          <div className="card-row"> 
            <Card projectName="Twitter + Youtube : A Backend" imageUrl={img} description="A social media backend leveraging Express.js and MongoDB to provide twitter and youtube features in a single app." githubLink="https://github.com/Mohil027/Decentralized_social_media_backend" />
        ...
        {activeTab === 'section2' && (
          <>
          <div className="card-row">
            <Card projectName="Fake Reviews Detection System" imageUrl={img} description="Unveiling the Truth: Achieving 95% Accuracy in Fake Review Detection with PyTorch, GPT, and Bert." githubLink="https://github.com/Mohil027/Fake-Reviews-Classification" />
            <Card projectName="Inverse Scaling Less GPT2" imageUrl={img2} description="Unleashing Precision: Harnessing Attention Masking for Inverse Scaling in GPT-2 Models." githubLink="https://github.com/Mohil027/Gpt2-inverse_scaling_solution" />
          ...
          <div className="card-row">
            <Card projectName="Mammograms Colorization" imageUrl={img} description="Enhancing Early Detection: Automating Breast Cancer Diagnosis with GAN-Based Mammogram Colorization for Improved Visualization and Accuracy." githubLink="https://link.springer.com/chapter/10.1007/978-981-19-5037-7_2" />
